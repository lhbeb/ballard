                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 py-4">
                    <div className="bg-[#3b82f6]/5 border border-[#3b82f6]/20 rounded-2xl p-6">
                        <h3 className="text-xl font-semibold text-gray-900 mb-4 flex items-center gap-2">
                            <CheckCircle className="text-[#3b82f6]" /> You CAN:
                        </h3>
                        <ul className="space-y-3">
                            <li className="flex gap-2"><span className="text-[#3b82f6] flex-shrink-0">•</span> Use the audio in personal, educational, and commercial projects (e.g., YouTube videos, podcasts, indie games, films).</li>
                            <li className="flex gap-2"><span className="text-[#3b82f6] flex-shrink-0">•</span> Modify, cut, splice, and process the audio to fit your project.</li>
                            <li className="flex gap-2"><span className="text-[#3b82f6] flex-shrink-0">•</span> Use the audio without required attribution (though tagging/crediting Ballard Kelly Scott is highly appreciated!).</li>
                            <li className="flex gap-2"><span className="text-[#3b82f6] flex-shrink-0">•</span> Monetize the videos or projects that incorporate this audio.</li>
                        </ul>
                    </div>
